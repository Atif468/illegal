...
export default function AviatorGame() {
  ...
  useEffect(() => {
    progressInterval.current = setInterval(() => {
      setProgress((prev) => (prev < 120 ? prev + 2 : 120));
    }, 300);
  ...
  const handleButtonClick = () => {
    ...
    clearInterval(countdownInterval.current); // Clear existing interval to prevent stacking
    setTimeLeft(15);
  ...
  return (
    <div className="flex items-center justify-center h-screen bg-black text-white relative">
      ...
      <div className="w-80 p-4 rounded-lg text-center relative">
        ...
        <img src="/aviator-logo.png" className="h-24 m-auto" alt="Aviator Logo" />
